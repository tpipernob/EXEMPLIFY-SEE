      ...
      <q-card>
        ...
        <q-tab-panels v-model="tab" animated>
          ...
          <q-tab-panel name="tab-atividades">
            ...
            <div v-show="tipoExemplo == 'correto' && nivelAluno == 'intermediario'">
              <div class="text-body1">
                Deseja combinar essa atividade com outra utilizando exemplos errôneos?.
              </div>
              <div class="q-pa-md">
                <div class="q-gutter-sm">
                  <q-radio
            ...
            <div v-show="atividadeCombinada == 'sim' && tipoExemplo == 'correto' && nivelAluno == 'intermediario'">
              <div class="text-body1">
                Deseja adicionar um artefato para os alunos utilizarem durante a correção de seus diagramas?
              </div>
              <div class="q-pa-md">
                <div class="q-gutter-sm">
                  <q-radio
            ...
            <div v-show="atividadeCombinada == 'sim' && tipoExemplo == 'correto' && nivelAluno == 'intermediario'">
              <div class="text-body1">
                Como desejar realizar a primeira correção dos modelos construídos pelos alunos?
              </div>
              <div class="q-pa-md">
                <div class="q-gutter-sm">
                  <q-radio
            ...
            <div v-show="tipoExemplo == 'erroneo' && nivelAluno == 'iniciante' && tipoArtefatoInicio == 'dominio'">
              <div class="text-body1">
                Deseja adicionar um artefato para os alunos utilizarem durante a correção de seus diagramas?
              </div>
              <div class="q-pa-md">
            ...
            <div v-show="tipoExemplo == 'erroneo' && nivelAluno == 'intermediario'">
              <div class="text-body1">
            ...
            <div v-show="tipoExemplo == 'erroneo' && nivelAluno == 'intermediario' && tipoAtividadeIntermediario == 'alunosIdentificandoErros'">
              <div class="text-body1">
      ...
      <q-card>
        <q-tab-panels v-model="tab" animated>
          ...
          <q-tab-panel name="tab-atividades">
            ...
            <div id="q-app" v-show="tipoExemplo == 'correto' && nivelAluno == 'intermediario'">
              <div class="q-px-lg q-pb-md">
                <q-timeline color="primary">
                  <q-timeline-entry title="Escolher o exemplo">
                    <div>
                      Professor seleciona exemplos positivos de um determinado modelo. Caso não possua exemplo, realize uma busca no <a href="/repositorioExemplos" target="_blank">Repositório de exemplos</a>
                    </div>
                  </q-timeline-entry>
                  ...
                  <q-timeline-entry title="Apresentar um domínio">
                    <div>
                      Professor apresenta um domínio para modelagem e explica aos alunos que o conceitos aprendidos com os exemplos corretos serão avaliados.
                    </div>
                  </q-timeline-entry>
                  <q-timeline-entry title="Realização da modelagem" >
                    <div>
                ...
                <spam v-show="atividadeCombinada == 'sim'">
                  <q-timeline-entry title="Selecionar anti-padrões">
                    <div>
                      Professor seleciona os anti-padrões que deseja ensinar. Caso não possua, realize uma busca no <a href="/repositorioExemplos" target="_blank">Repositório de exemplos</a>
                    </div>
                  </q-timeline-entry>
                  <q-timeline-entry title="Explicação dos anti-padrões" >
                    <div>
                      Professor apresenta os anti-padrões e mostra como solucioná-los.
                    </div>
                  </q-timeline-entry>
                  <q-timeline-entry v-if="adicionarArtefato == 'sim'" title="Disponibilizar artefato" >
                    <div>
                      Professor disponibiliza um checklist com os anti-padrões ensinados ou um artefato educacional de inspeção.
                    </div>
                  </q-timeline-entry>
                  <q-timeline-entry v-if="primeiraCorrecao == 'proprio'" title="Correção do diagrama" >
                    <div>
                      Alunos realizam a correção dos seus diagramas.
                    </div>
                  </q-timeline-entry>
                  <q-timeline-entry v-if="primeiraCorrecao == 'unsDosOutros'" title="Correção do diagrama" >
                    <div>
                      Alunos realizam a correção dos diagramas de outros colegas da turma.
                    </div>
                  </q-timeline-entry>
                  <q-timeline-entry title="Nova versão dos diagramas" >
                    <div>
                      Alunos realizam a nova versão dos diagramas aplicando as correções.
                    </div>
                  </q-timeline-entry>
                </spam>
            ...
            <div id="q-app" v-show="tipoExemplo == 'erroneo' && nivelAluno == 'iniciante' && tipoArtefatoInicio == 'dominio'">
              <div class="q-px-lg q-pb-md">
                <q-timeline color="primary">
                  <q-timeline-entry title="Apresentar um domínio">
                    <div>
                      Professor apresenta um domínio para que os alunos realizagem a modelagem.
                    </div>
                  </q-timeline-entry>
            ...
            <div id="q-app" v-show="tipoExemplo == 'erroneo' && nivelAluno == 'iniciante' && tipoArtefatoInicio == 'modeloErros'">
              <div class="q-px-lg q-pb-md">
                <q-timeline color="primary">
                  <q-timeline-entry title="Modelo com erros">
                    <div>
                      Como os alunos são de nível iniciante, o professor apresenta um modelo simples com erros. Caso não possua exemplo, realize uma busca no <a href="/repositorioExemplos" target="_blank">Repositório de exemplos</a>
                    </div>
                  </q-timeline-entry>

                  <q-timeline-entry title="Explicação do modelo">
                    <div>
                      Professor explica os erros existentes no modelo.
                    </div>
                  </q-timeline-entry>
                  <q-timeline-entry title="Demonstração">
                    <div>
                      Professor faz o passo a passo para corrigir os erros dos modelos.
                    </div>
                  </q-timeline-entry>
                  <q-timeline-entry title="Apresentar outro modelo" >
                    <div>
                      Professor apresenta outro modelo com erros similares aos apresentados no passo anterior.
                    </div>
                  </q-timeline-entry>
                  <q-timeline-entry title="Identificação dos erros" >
                    <div>
                      Os alunos devem identificar os erros que existem no modelo apresentado.
                    </div>
                  </q-timeline-entry>
                  <q-timeline-entry title="Correção do modelo" >
                    <div>
                      Alunos criam um novo modelo com uma forma de solucionar os erros existentes.
                    </div>
                  </q-timeline-entry>
                  <q-timeline-entry title="Feedback" >
                    <div>
            ...
            <div id="q-app" v-show="tipoExemplo == 'erroneo' && nivelAluno == 'intermediario' && tipoAtividadeIntermediario == 'modeloErros'">
              <div class="q-px-lg q-pb-md">
                <q-timeline color="primary">
                  <q-timeline-entry title="Modelo com erros">
                    <div>
                      Como os alunos são de nível intermediário, o professor apresenta um modelo com erros de maior complexidade. Caso não possua exemplo, realize uma busca no <a href="/repositorioExemplos" target="_blank">Repositório de exemplos</a>
                    </div>
                  </q-timeline-entry>
            ...
            <div id="q-app" v-show="tipoExemplo == 'erroneo' && nivelAluno == 'intermediario' && tipoAtividadeIntermediario == 'jogo7erros'">
              <div class="q-px-lg q-pb-md">
                <q-timeline color="primary">
                  <q-timeline-entry title="Início do jogo">
                    <div>
                      Professor apresenta um modelo com 7 erros e explica as regras do jogo. Caso não possua exemplo, realize uma busca no <a href="/repositorioExemplos" target="_blank">Repositório de exemplos</a>
                    </div>
                  </q-timeline-entry>

                  <q-timeline-entry color="orange" title="Início do ciclo de localização de erros">
                    <div>
                      O aluno que encontrar um erro deve se manifestar e explicar o motivo do erro.
                    </div>
                  </q-timeline-entry>
                  <q-timeline-entry color="orange" title="Explicação">
                    <div>
                      A explicação do aluno é acompanhada pela turma
                    </div>
                  </q-timeline-entry>
                  <q-timeline-entry color="orange" title="Validação do erro encontrado" >
                    <div>
                      O Professor realiza a validação do que foi apresentado pelo aluno. Se o aluno acertou, recebe a pontuação, caso contrário, o erro continua em aberto.
                    </div>
                  </q-timeline-entry>
                  <q-timeline-entry color="orange" title="Fim do ciclo de localização de erros" >
                    <div>
                      Caso algum erro não tenha sido localizado, o professor deve explciar o erro.
                    </div>
                  </q-timeline-entry>
                  <q-timeline-entry title="Correção do modelo" >
                    <div>
            ...
            <div id="q-app" v-show="tipoExemplo == 'erroneo' && nivelAluno == 'intermediario' && tipoAtividadeIntermediario == 'alunosIdentificandoErros'">
              <div class="q-px-lg q-pb-md">
                <q-timeline color="primary">
                  <q-timeline-entry title="Modelo com erros">
                    <div>
                  ...
                  <q-timeline-entry title="Localização dos erros">
                    <div>
                      Professor estabelece um tempo para os alunos identificarem os erros existentes.
                    </div>
                  </q-timeline-entry>
                  <q-timeline-entry title="Apresentação dos erros">
                    <div>
                      Os alunos relatam os erros encontrados por eles.
                    </div>
                  </q-timeline-entry>
                  <q-timeline-entry title="Correção dos erros apresentados" >
                    <div>
                      O Professor faz a correção dos erros identificados pelos alunos.
                    </div>
                  </q-timeline-entry>
                  <q-timeline-entry v-show="incluirAulaAntiPadroes == 'sim'" title="Apresentação de anti-padrões" >
                    <div>
                      Professor seleciona e apresenta os anti-padrões relacionados aos erros do modelo e mostra como solucioná-los.
                    </div>
                  </q-timeline-entry>
                  <q-timeline-entry title="Erros não localizados" >
                    <div>
                      Professor mostra os erros não localizados.
                    </div>
                  </q-timeline-entry>
                  <q-timeline-entry title="Correção do modelo" >
                    <div>
